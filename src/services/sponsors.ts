const SPONSORS = {
  ...
  runwayPileUp: {
    ...
    images: {
      large: {
        darkModeImage:
          'https://d2thv89fb05cma.cloudfront.net/polpiella.dev/images/sponsors/build-or-ship.png',
        lightModeImage:
          'https://d2thv89fb05cma.cloudfront.net/polpiella.dev/images/sponsors/build-or-ship.png',
        aspectRatio: 1,
      },
  ...
  stream: {
    ...
    images: {
      large: {
        darkModeImage:
          'https://d2thv89fb05cma.cloudfront.net/polpiella.dev/images/stream-logo.webp',
        lightModeImage:
          'https://d2thv89fb05cma.cloudfront.net/polpiella.dev/images/stream-logo.webp',
        aspectRatio: 1.72,
      },
  ...
  rocketHelm: {
    ...
    images: {
      large: {
        darkModeImage:
          'https://d2thv89fb05cma.cloudfront.net/polpiella.dev/images/sponsors/rocket-helm.webp',
        lightModeImage:
          'https://d2thv89fb05cma.cloudfront.net/polpiella.dev/images/sponsors/rocket-helm.webp',
        aspectRatio: 1.6,
      },
  ...
  concurrencyCourse: {
    ...
    images: {
      large: {
        darkModeImage:
          'https://d2thv89fb05cma.cloudfront.net/polpiella.dev/images/sponsors/concurrency_swift_banner.webp ',
        lightModeImage:
          'https://d2thv89fb05cma.cloudfront.net/polpiella.dev/images/sponsors/concurrency_swift_banner.webp ',
        aspectRatio: 1.82,
      },
