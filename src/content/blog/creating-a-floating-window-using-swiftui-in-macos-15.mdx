...
excerpt: "Leverage the power of the new SwiftUI APIs in macOS 15 to create a movable and resizable floating window that stays on top of the user's screen."
pubDate: 2024-06-11
tags: ['swiftui', 'wwdc24']
...
During the [What's new in SwiftUI](https://developer.apple.com/wwdc24/10149) session, Apple introduced a new set of APIs for window management that, among other things, allows you to set the floating level of a specific window in your app. This modifier can be used to very easily create a floating window in SwiftUI: 
