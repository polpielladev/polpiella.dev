...
I have recently open-sourced a Swift command line tool that allows you to use Open AI's ChatGPT directly from the command line: [chatty](https://github.com/polpielladev/chatty-cli).

Along with the opportunity to release an open source project, I took [chatty]() as an opportunity to look into how I could automate the release process of my new command line tool using GitHub Actions.

## The release process

I wanted to make [chatty](https://github.com/polpielladev/chatty-cli) easy both for me to release new versions and for users to install the latest version of the tool. I had a clear idea of the channels I wanted to use to distribute [chatty](https://github.com/polpielladev/chatty-cli):

1. [Homebrew](https://brew.sh).
2. [GitHub releases](https://docs.github.com/en/repositories/releasing-projects-on-github/managing-releases-in-a-repository).
...
As the project is open source and GitHub offers unlimited free minutes for public repositories, I decided to use it as my CI/CD provider.
