...
The final step of the workflow is to upload the build to `TestFlight`. To achieve this, click on the `+` button next to the `Post-Actions` section title and select the `TestFlight Internal Testing` option from the list.
