...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/polpielladev/sourcery-plugins.git", branch: "main")
    ],
    targets: [
        .target(
            name: "SourceryPluginSample",
...
<Video name="sourcery-command-cli.mp4" />
