...
pubDate: 2023-01-04
tags: ['ci-cd', 'xcode-cloud', 'fastlane']
...
> [CocoaPods](https://cocoapods.org) installs and links all its dependencies by creating a `.xcworkspace`. You need to update your workflow to use this `.xcworkspace` instead of the default `.xcodeproj` file. <Video name="xcode-cloud-scripts.mp4" />
