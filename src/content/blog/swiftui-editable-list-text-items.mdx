...
The `EditableListItem` component also adds a context menu to the `ZStack` which allows the user to rename the item by clicking on the "Rename" menu item to make the feature more discoverable.
