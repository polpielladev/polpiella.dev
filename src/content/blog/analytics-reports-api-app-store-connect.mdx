...
In this article, I'll show you how to access these new metrics using [Antoine Van Der Lee]()'s [App Store Connect Swift SDK](https://github.com/AvdLee/appstoreconnect-swift-sdk).
...
let instances = APIEndpoint
    ...
    .id(crashesReportId)
    .instances
    .get(parameters: .init(filterGranularity: [.]))
