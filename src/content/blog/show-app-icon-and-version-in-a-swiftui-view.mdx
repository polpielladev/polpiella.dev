...
The first step to building the view is to get the app icon from the main bundle. This can be done by retrieving the values for a set of keys in the app's `Info.plist` file:
