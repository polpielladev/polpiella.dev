...
Finally, as you're no longer using the Swift package's library product with the macro definition, you will need to declare it in your target's source files. To do so, create a new Swift file and copy the macro definition from the Swift package over:
