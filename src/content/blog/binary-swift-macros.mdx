...
Due to the way they are implemented and their tight coupling with SPM, Swift macros **can only be defined in Swift packages** and, as such, they are usually imported into Xcode projects such as iOS apps or frameworks as **SPM dependencies**.
