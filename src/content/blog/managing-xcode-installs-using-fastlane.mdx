...
The [2.211.0 release of Fastlane](https://github.com/fastlane/fastlane/releases/tag/2.211.0) comes with a brand new action: [xcodes](https://docs.fastlane.tools/actions/xcodes). This new action allows you to install, select and manage multiple versions of Xcode directly from Fastlane.
