...
The merge [PR #6114](https://github.com/apple/swift-package-manager/pull/6114) in the Swift Package Manager repository confirms one of the features I have long been waiting for: the ability to make network requests in Swift package plugins.
...
```swift:Plugins/Local/Local.swift
@main
struct Local: CommandPlugin {
    func performCommand(context: PluginContext, arguments: [String]) throws {
