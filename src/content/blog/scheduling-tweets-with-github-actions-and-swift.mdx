...
If you want to dig into the code and find out more about the implementation details, [I have made the repository public on Github](https://github.com/pol-piella/weekly-tweet-cron-job).
