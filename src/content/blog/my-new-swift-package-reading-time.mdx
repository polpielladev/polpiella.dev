...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/polpielladev/reading-time.git", from: "1.0.0")
    ],
    ...
)
```
...
If you want to be part of the process, feel free to create a PR or raise an issue for a feature you'd like to see ✨ or a bug you'd like to fix 🐛 in [ReadingTime's repo](https://github.com/polpielladev/reading-time)!
