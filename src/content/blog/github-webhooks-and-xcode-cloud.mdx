...
Webhooks are messages that get sent when certain events occur on a website. Webhooks are a fantastic way of building custom integrations based on the data they provide, hence allowing users to expand an app's capabilities through them.
...
Then, whenever the event occurs, the website sends a `POST` request to the provided URL with the relevant data in the request's body.
...
![The Cloud section in the report navigator menu of Xcode](https://res.cloudinary.com/dflewmkx4/image/upload/ac_none,f_auto,q_auto:eco/v1678797532/blog/posts/github-webhooks-and-xcode-cloud/manage-workflows.png)
