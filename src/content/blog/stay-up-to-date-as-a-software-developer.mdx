...
There are plenty of RSS readers available out there, but my all-time favourite is the macOS application [NetNewsWire](), which also comes with a Safari extension that detects RSS feeds in the websites you visit and allows you to subscribe to them with a single click:
