  ...
  const markup = html`<html>
    <body style="margin: 0; padding: 0">
      <div
        ...
        <div
          style="width: 100%; height: 100%; display: flex; align-items: center; margin-left: 150px;">
          <h1
            style="width: 100%; color: #FFFBFB; max-width: 900px; font-size: 85px; line-height: 102.87px; font-weight: 500;">
            ${title}
          </h1>
        </div>
        <div
          style="display: flex; position: absolute; bottom: 20px; right: 40px; align-items: center;">
          <img
          ...
          <div style="color: #FFFBFB; display: flex; flex-direction: column;">
            <p
              style="font-size: 20px; font-weight: bold; margin: 0; margin-bottom: 8px;">
              Pol Piella Abadia
            </p>
